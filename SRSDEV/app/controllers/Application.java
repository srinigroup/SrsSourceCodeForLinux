...
public class Application extends Controller {
	...
	static {
		...
		try {
			//input = new FileInputStream("./public/test.properties"); // for play
			 input = new FileInputStream("/var/www/html/SRSFiles/PropFiles/test.properties"); //for tomcat
	...
	public static String upload(String id, String fName,
		...
		//final String  basePath  = "/home/roots/web/pdfs/";// Path for saving files in linux system 
		final String  basePath  = "/opt/pdfs/";
	...
	public static Result javascriptRoutes() {
		...
		return ok(Routes.javascriptRouter("myJsRoutes",
				...
				routes.javascript.HoForms.uploadHoFormsByHeadOffice()));
	}
