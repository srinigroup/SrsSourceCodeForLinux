...
public class InvoiceInventory extends Controller {
	...
	//private static String basePath = "/home/roots/web/pdfs/"; 																// tomcat
	//private static String basePath = "/opt/pdfs/";																// other
																	// than
																	// webapps
																	// folder,D
																	// Drive
...
*/
	...
	public static Result uploadInvoicesByHeadOffice() throws Exception {
		...
		Logger.debug("@C InvoiceInventory -->> uploadInvoicesByHeadOffice() -->> ");
	...
	public static Result getInvoicesAfterMove(Long storeId, String invoiceType) {
		...
		Logger.debug("@C InvoiceInventory -->> getInvoicesAfterMove(store id :"
				+ storeId + "," + invoiceType + ") -->> ");
